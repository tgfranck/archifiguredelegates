...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.COLOR_VIEW_LEGEND: {
				ColorViewLegend colorViewLegend = (ColorViewLegend)theEObject;
				T result = caseColorViewLegend(colorViewLegend);
				if (result == null) result = caseDiagramModelNote(colorViewLegend);
				if (result == null) result = caseDiagramModelObject(colorViewLegend);
				if (result == null) result = caseTextContent(colorViewLegend);
				if (result == null) result = caseTextPosition(colorViewLegend);
				if (result == null) result = caseConnectable(colorViewLegend);
				if (result == null) result = caseFontAttribute(colorViewLegend);
				if (result == null) result = caseLineObject(colorViewLegend);
				if (result == null) result = caseTextAlignment(colorViewLegend);
				if (result == null) result = caseDiagramModelComponent(colorViewLegend);
				if (result == null) result = caseIdentifier(colorViewLegend);
				if (result == null) result = caseCloneable(colorViewLegend);
				if (result == null) result = caseAdapter(colorViewLegend);
				if (result == null) result = caseNameable(colorViewLegend);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Color View Legend</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Color View Legend</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColorViewLegend(ColorViewLegend object) {
		return null;
	}
