 ...
 */
public class BoxFigureDelegate extends AbstractPolygonalFigureDelegate {
	...
	public PointList getPoints() {
        ...
        points.addPoint(bounds.x, bounds.y + FOLD_HEIGHT);
        points.addPoint(bounds.x + FOLD_HEIGHT, bounds.y);
        points.addPoint(bounds.x + bounds.width - 1, bounds.y);
        points.addPoint(bounds.x + bounds.width - 1, bounds.y + bounds.height - FOLD_HEIGHT - 1);
        points.addPoint(bounds.x + bounds.width - FOLD_HEIGHT - 1, bounds.y + bounds.height - 1);
