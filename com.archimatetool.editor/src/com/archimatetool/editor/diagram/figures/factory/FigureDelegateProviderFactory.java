	...
	private void registerProviders() {
	    ...
	    for(IConfigurationElement configurationElement : registry.getConfigurationElementsFor(IFigureDelegateProvider.EXTENSIONPOINT_ID)) {
	        try {
	            ...
	            Class<? extends IFigure> providerFor = ((Class<? extends IFigure>) Class.forName(configurationElement.getAttribute("providerFor")));
	            Class<? extends IFigureDelegate> defaultDelegateType = ((Class<? extends IFigureDelegate>) Class.forName(configurationElement.getAttribute("defaultDelegate")));
	            
	            IFigureDelegateProvider provider = new FigureDelegateProvider(providerFor, defaultDelegateType);
	            
	            if(id != null && providerFor != null && defaultDelegateType != null && provider != null) {
